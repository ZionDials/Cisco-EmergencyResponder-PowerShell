<#
	.SYNOPSIS
        Publish the Cisco-EmergencyResponder-PowerShell module to the PowerShell Gallery.
    .DESCRIPTION
        The Cisco-EmergencyResponder-PowerShell gets published to a public nuget feed. This
...
$moduleName = "Cisco-EmergencyResponder-PowerShell"
